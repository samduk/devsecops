...
BUCKET_NAME="Your_Photo_BucketName"
#DB_HOSTNAME=os.getenv("DB_HOSTNAME") 
f=open('/home/ubuntu/config.txt')
h=f.read()
DB_HOSTNAME=h.strip()
print(DB_HOSTNAME)
...
def s3uploading(filename, filenameWithPath):
    ...
    return "http://"+BUCKET_NAME+".s3."+REGION+".amazonaws.com/"+ path_filename 
...
def home_page():
    ...
    ip=r.text
    return render_template('index.html', photos=items, ip=ip)    
